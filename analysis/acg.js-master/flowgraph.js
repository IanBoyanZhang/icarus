...
module.exports.addIntraproceduralFlowGraphEdges = addIntraproceduralFlowGraphEdges;
module.exports.funcVertex = funcVertex;
module.exports.unknownVertex = unknownVertex;
module.exports.propVertex = propVertex;
module.exports.nativeVertex = nativeVertex;
module.exports.getNativeVertices = getNativeVertices;
module.exports.parmVertex = parmVertex;
module.exports.argVertex = argVertex;
module.exports.retVertex = retVertex;
module.exports.resVertex = resVertex;
//   return exports;
// });